package com.treasure.cropview.ui;
...
import com.treasure.cropview.animation.SimpleValueAnimator;
import com.treasure.cropview.animation.SimpleValueAnimatorListener;
import com.treasure.cropview.animation.ValueAnimatorV14;
import com.treasure.cropview.animation.ValueAnimatorV8;
import com.treasure.cropview.callback.Callback;
import com.treasure.cropview.callback.CropCallback;
import com.treasure.cropview.callback.CropRequest;
import com.treasure.cropview.callback.LoadCallback;
import com.treasure.cropview.callback.LoadRequest;
import com.treasure.cropview.callback.SaveCallback;
import com.treasure.cropview.callback.SaveRequest;
import com.treasure.cropview.utils.Utils;
...
public class CropImageView extends ImageView {
    ...
    private Bitmap getRotatedBitmap(Bitmap bitmap) {
        ...
        rotateMatrix.postRotate(mAngle, bitmap.getWidth() / 2, bitmap.getHeight() / 2);
        ...
        try {
            ...
            if (mAngle != 0) {
                ...
                cropRect = new Rect((int) rotated.left, (int) rotated.top, (int) rotated.right,
                        (int) rotated.bottom);
                if (mScale == 90) {
                    cropRect = new Rect((int) rotated.left - 50, (int) rotated.top - 50, (int) rotated.right - 50,
                            (int) rotated.bottom - 50);
                }
            }
    ...
    private Rect calcCropRect(int originalImageWidth, int originalImageHeight) {
        float rotatedWidth = getRotatedWidth(mAngle, originalImageWidth, originalImageHeight);
        float scaleToOriginal =
                rotatedWidth / mImageRect.width();
